...
b=[[4,5],[11.9,12.4],[-3.15,3.15],[-3.15,3.15],[-1,1],[-1,1],[0.1,9.2] ]
...
for box in components[0]:
    rectangle= plt.Rectangle((float(box[2].lower()),float(box[3].lower()) ), \
        5*float(box[2].upper())-5*float(box[2].lower()),5*float(box[3].upper())-5*float(box[3].lower()), fc='r')
    plt.gca().add_patch(rectangle)
for box in components[1]:
    rectangle= plt.Rectangle((float(box[2].lower()),float(box[3].lower()) ), \
        5*float(box[2].upper())-5*float(box[2].lower()),5*float(box[3].upper())-5*float(box[3].lower()), fc='g')
    plt.gca().add_patch(rectangle)        
for box in components[2]:
    rectangle= plt.Rectangle((float(box[2].lower()),float(box[3].lower()) ), \
        5*float(box[2].upper())-5*float(box[2].lower()),5*float(box[3].upper())-5*float(box[3].lower()), fc='b')
    plt.gca().add_patch(rectangle)  
